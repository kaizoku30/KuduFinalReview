...
class LoginVM {
    var getSelectedLanguage: LanguageSelectionView.LanguageButtons { self.selectedLanguage }
    private var selectedLanguage: LanguageSelectionView.LanguageButtons = .arabic
    ...
    init(selectedLang: LanguageSelectionView.LanguageButtons, _delegate: LoginVMDelegate, _expiryError: String? = nil) {
